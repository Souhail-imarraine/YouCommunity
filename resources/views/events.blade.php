...
<body class="bg-gray-50">
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-in-out z-40">
    ...
    <div class="lg:ml-64 p-4 lg:p-8 mt-16 lg:mt-0">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 space-y-4 lg:space-y-0">
            ...
            <button onclick="openAddEventModal()" class="w-full lg:w-auto bg-gradient-to-r from-blue-800 to-emerald-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition duration-300 flex items-center justify-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm mb-6">
            <div class="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <select class="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-800 focus:border-transparent">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <img class="h-8 w-8 lg:h-10 lg:w-10 rounded-lg object-cover"
                                        src="https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="">
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">Festival de Musique 2024</div>
                                        <div class="text-xs lg:text-sm text-gray-500">Paris, France</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-3">
                                    <button class="text-blue-800 hover:text-emerald-600 transition-colors duration-200 edit-button">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </button>
                                    <button class="text-red-600 hover:text-red-800 transition-colors duration-200 delete-button" data-event-id="1">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <!-- Répétez ce bloc pour plus d'événements -->
                    </tbody>
                </table>
            </div>
            ...
            <div class="bg-white px-4 py-3 border-t border-gray-200">
                <div class="flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div class="flex justify-center w-full lg:w-auto space-x-2">
                        <a href="#" class="relative inline-flex items-center px-3 py-2 rounded border border-gray-300 text-sm font-medium bg-white text-gray-700 hover:bg-gray-50">
                            Précédent
                        </a>
                        <div class="hidden lg:flex space-x-2">
                            <a href="#" class="relative inline-flex items-center px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">1</a>
                            <a href="#" class="relative inline-flex items-center px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">2</a>
                            <a href="#" class="relative inline-flex items-center px-3 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">3</a>
                        </div>
                        <a href="#" class="relative inline-flex items-center px-3 py-2 rounded border border-gray-300 text-sm font-medium bg-white text-gray-700 hover:bg-gray-50">
                            Suivant
                        </a>
            ...
            <div class="flex flex-col space-y-4">
                ...
                <form class="space-y-4">
                    ...
                    <div class="flex flex-col items-center space-y-3">
                        <img id="editEventImage" src="https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                    ...
                    <div>
                        ...
                        <input type="text" id="editEventName" name="name"
    ...
    <script>
        ...
        function openEditModal(eventData) {
            ...
            document.getElementById('editEventImage').src = eventData.image;
            ...
            document.getElementById('editCapacity').value = eventData.capacity;
