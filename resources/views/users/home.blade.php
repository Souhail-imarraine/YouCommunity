...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <button
                class="bg-gradient-to-r from-blue-800 to-emerald-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition duration-300 flex items-center">
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                ...
                                sur <span class="font-medium">97</span> résultats
                            </p>
                        </div>
                        <div>
