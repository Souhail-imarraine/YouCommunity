        ...
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center space-x-6">
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <a href="/login" class="text-gray-700 hover:text-blue-800 font-medium">Connexion</a>
                    <a href="/register" class="bg-gradient-to-r from-blue-800 to-emerald-600 text-white px-6 py-3 rounded-lg hover:opacity-90 transition duration-300 font-medium flex items-center">
        ...
        <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="mt-10 flex justify-center gap-x-6">
                    ...
                    <a href="/register" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-800 transition duration-300">
                        Registre
                    </a>
                </div>
            </div>
    ...
    <footer class="bg-gray-900 text-white">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <!-- ... existing footer content with updated styling ... -->
            </div>
